...
1. Text Based File
2. Directory of Text Based Files
3. Raw Text

# Naming Skill Directory
Text Based File
1. Use Text File Title Case Initials as prefix
...
1. Use Directory Name Title Case Initials as prefix
2. Use actionable text derived from content for 2nd part / rest of skill name (suffix) using "TEXT-TEXT-TEXT" convention

Raw Text
1. Analyze raw text for intent and what is taught in text
2. Use actionable text derived from content for 2nd part / rest of skill name (suffix) using "TEXT-TEXT-TEXT" convention

Examples:

When Text File Name: TextFileName

Final Skill Name: TFN-TEXT-TEXT-TEXT

When Text File Name: Textfilename

Final Skill Name: Textfilename-TEXT-TEXT-TEXT
...
When Directory Name: DirectoryName

Final Skill Name: DN-TEXT-TEXT-TEXT

When Directory Name: Directoryname

Final Skill Name: Directoryname-TEXT-TEXT-TEXT
...
Final Skill Name: TEXT-TEXT-TEXT
...
1. Create folder directory following "Naming Skill Directory" above.

2. Analyze full Text content.

3. Identify every and all actionable parts of the full Text content.

4. From every identified actionable parts synthesis the behavior and intent of what is being taught in the full Text content into 1 sentence to use as Skill "Description".

5. Identify step by step instructions from the full Text content.

6. Read the "skill-template.md" file completely to use as reference for creating "SKILL.md" file in next steps. Document required sections and verify them before file creation.

7. Create a SKILL.md file using template "skill-template.md" file in directory populated with step by step instructions of what is taught in full Text content.

8. Update SKILL.md file with duplicate parts of the template that make sense to have duplicate sections for different parts of the actionable identified parts of full Text content.

9. Update SKILL.md behavior instructions to always start of using ask_user or questions tool to ask user of desired goal results output when using skill. (Include Instructions  "Identifying and Verifying Skill Execution Goal" above)

10. If SKILL.md file does not already have a way to verify user goal with skill execution based of full Text content update SKILL.md behavior instructions to always use ask_user or questions tool to ask user how to verify whether goal has been achieved.

11. Update SKILL.md behavior instructions to always check for existing "SKILLNAME-Execution-Metrics.md" file for previous results of skill executed to analyze before executing skill behavior instructions in order to avoid any previous mistakes made from executing skill.

12. Update SKILL.md behavior instructions to always end with creating "SKILLNAME-Execution-Metrics.md" populating or appending results from skill execution with timestamp and prompt provided to skill use execution.


Directory of Text Based Files
1. Run parallel sub agents for every text file in the provided directory to follow the above "Text Based File" instructions.

Raw Text
1. Run parallel sub agent to follow the above "Text Based File" instructions.
